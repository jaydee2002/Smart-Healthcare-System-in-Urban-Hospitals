...
import {
  ...
  getMyAppointments,
  cancelAppointment,
} from "../../src/controllers/appointController.js";
...
const fakeAppointment = (overrides = {}) => ({
  ...
  timeSlot: {
    start: new Date("2025-10-05T08:00:00Z"),
    end: new Date("2025-10-05T09:00:00Z"),
  },
  status: "booked",
  save: jest.fn().mockResolvedValue(true),
  ...overrides,
...
describe("appointmentController", () => {
  ...
  describe("getAvailableSlots", () => {
    ...
    it("returns slots for given date", async () => {
        ...
        availability: [
          {
            ...
            timeSlots: [
              {
                start: new Date("2025-10-10T08:00:00Z"),
                end: new Date("2025-10-10T09:00:00Z"),
                isBooked: false,
              },
              {
                start: new Date("2025-10-10T09:00:00Z"),
      ...
      const req = mockReq({
        params: { doctorId: "d1" },
        query: { date: "2025-10-10T00:00:00Z" },
      });
      const res = mockRes();
            ...
            timeSlots: [
              {
                ...
                end: new Date(later.getTime() + 3600000),
                isBooked: false,
              },
            ],
          },
  ...
  describe("bookAppointment", () => {
    ...
    it("books in PRIVATE hospital with successful payment", async () => {
      ...
      expect(res.status).toHaveBeenCalledWith(201);
      expect(res.json).toHaveBeenCalledWith(
        expect.objectContaining({ paymentId: "pi_mock" })
      );
    });
